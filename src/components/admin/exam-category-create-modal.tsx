...
interface ExamCategoryCreateModalProps {
  onSuccess?: () => void;
}

export function ExamCategoryCreateModal({ onSuccess }: ExamCategoryCreateModalProps = {}) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        console.error("Failed to create exam category:", errorData.error);
        alert(errorData.error || "Failed to create exam category");
      }
    } catch (error) {
      console.error("Error creating exam category:", error);
      alert("Error creating exam category");
    } finally {
